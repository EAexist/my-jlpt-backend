...
- [X] T003a [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/introduction.md] Add API base path `/api/v1` in src/main.ts
- [X] T003b [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/techniques/configuration.md] Add global config loading in src/main.ts
- [X] T003c [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/pipes.md] Add validation plumbing in src/main.ts
- [X] T004 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/techniques/configuration.md] Define required environment variables and defaults in src/common/config/env.schema.ts
- [X] T005 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/exception-filters.md] Add shared API response/error constants matching ApiError in src/common/api/api-error.ts
- [X] T006 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/fundamentals/unit-testing.md] Create reusable test application bootstrap helpers in src/common/testing/app-test-utils.ts
...
- [X] T007 [docs|.standard-codes/ref-repos/docs.nestjs/content/recipes/prisma.md] Define Prisma models and enums for Learner, Group, Content, ProcessingJob, SentenceAnalysis, GrammarPoint, GrammarExample, GrammarExampleCache, VocabularyItem, and UploadedFile in prisma/schema.prisma
- [X] T008 [docs|.standard-codes/ref-repos/docs.nestjs/content/recipes/prisma.md] Generate Prisma migration for the JLPT data model in prisma/migrations/001_jlpt_backend_api/migration.sql
- [X] T009 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/recipes/prisma.md] Add PrismaModule and PrismaService lifecycle management in src/prisma/prisma.module.ts and src/prisma/prisma.service.ts
- [X] T010 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/custom-decorators.md] Add current learner request type and decorator in src/auth/current-learner.decorator.ts
- [X] T011 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/security/authentication.md] Implement bearer token verification with jose in src/auth/bearer-auth.guard.ts
- [X] T012 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/security/authorization.md] Implement ownership and resource error helpers in src/auth/ownership.service.ts
- [X] T013 [P] [docs|.standard-codes/ref-repos/docs.nestjs/content/pipes.md] Implement Zod validation pipe and exception mapping in src/common/validation/zod-validation.pipe.ts
...
- [ ] T022 [P] [US1] [docs|.standard-codes/ref-repos/zod/...] Define sync request and user response Zod schemas in src/auth/auth.schemas.ts
- [ ] T023 [US1] [docs|] Implement idempotent learner upsert and default group creation in src/auth/auth.service.ts
...
- [ ] T028 [P] [US2] [docs|.standard-codes/ref-repos/zod/...] Create group request and response Zod schemas in src/group/group.schemas.ts
- [ ] T029 [US2] [docs|] Implement group list, create, read, delete, content count, and reassignment behavior in src/group/group.service.ts
...
- [ ] T035 [P] [US3] [docs|.standard-codes/ref-repos/zod/...] Replace content DTOs with multipart and response Zod schemas in src/content/content.schemas.ts
...
- [ ] T038 [US3] [docs|] Implement worker result callback persistence and idempotent terminal updates in src/job/job.service.ts
...
- [ ] T041 [US3] [docs|] Map persisted content into ProcessingContent, FailedContent, and CompletedContent contract shapes in src/content/content.presenter.ts
...
- [ ] T044 [US4] [docs|RxJS Subject/BehaviorSubject guide - https://rxjs.dev/guide/subject] Implement job status registry using per-job BehaviorSubject seeded from persisted ProcessingJob state, completing and evicting the subject on terminal status, in src/job/job-status.service.ts
- [ ] T045 [US4] [docs|RxJS Subject/BehaviorSubject guide - https://rxjs.dev/guide/subject] Push job lifecycle changes into the corresponding job-status registry subject in src/job/job.service.ts
- [ ] T046 [US4] [docs|.standard-codes/ref-repos/docs.nestjs/content/techniques/server-sent-events.md] Implement GET /content/{id}/status SSE endpoint that maps the registry stream to MessageEvents, auto-completes on terminal status, and handles client disconnect cleanup, in src/content/content.controller.ts
...
- [ ] T049 [P] [US5] [docs|.standard-codes/ref-repos/zod/...] Add pagination and move-content Zod schemas in src/content/content-management.schemas.ts
