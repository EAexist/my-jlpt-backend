...
- [ ] T010 [P] Add current learner request type and decorator in src/common/auth/current-learner.decorator.ts
- [ ] T011 [P] Implement bearer token verification with jose in src/common/auth/bearer-auth.guard.ts
- [ ] T012 [P] Implement ownership and resource error helpers in src/common/auth/ownership.service.ts
...
- [ ] T019 [P] [US1] Add contract tests for POST /auth/sync and GET /auth/me in src/auth/auth.contract.spec.ts
- [ ] T020 [P] [US1] Add authorization tests for missing and invalid bearer tokens in src/auth/auth.authz.spec.ts
- [ ] T021 [P] [US1] Add idempotent learner sync service tests in src/auth/auth.service.spec.ts
...
- [ ] T026 [P] [US2] Add contract tests for GET /groups, POST /groups, GET /groups/{groupId}, and DELETE /groups/{groupId} in src/group/group.contract.spec.ts
- [ ] T027 [P] [US2] Add private ownership and default group behavior tests in src/group/group.service.spec.ts
...
- [ ] T032 [P] [US3] Add contract tests for POST /content and GET /content/{id} lifecycle shapes in src/content/content.contract.spec.ts
- [ ] T033 [P] [US3] Add ingestion validation tests for exactly-one-source, file type, file size, and group ownership in src/content/content.ingestion.spec.ts
- [ ] T034 [P] [US3] Add generated result persistence tests for grammar examples and deduplicated vocabulary in src/content/content-results.service.spec.ts
...
- [ ] T042 [P] [US4] Add contract tests for GET /content/{id}/status SSE response shape in src/content/content-status.contract.spec.ts
- [ ] T043 [P] [US4] Add authorization tests for cross-learner status access in src/content/content-status.authz.spec.ts
...
- [ ] T047 [P] [US5] Add contract tests for GET /groups/{groupId}/content, PATCH /content/{id}, and DELETE /content/{id} in src/content/content-management.contract.spec.ts
- [ ] T048 [P] [US5] Add content ownership, pagination, move, and delete service tests in src/content/content-management.service.spec.ts
